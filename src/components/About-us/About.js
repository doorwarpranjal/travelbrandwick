...
<h1>About Us</h1>
<ul>
<li class="item"><Link to="/index">Home</Link></li>
<li class="item"><Link to="/about-us"><i class='bx bx-chevrons-right'></i>About</Link></li>
</ul>
</div>
</div>
<div class="bg-image">
...
<div class="about-btn">
<Link to="/contact" class="btn-primary">Contact Us</Link>
...
<Link to="https://www.youtube.com/watch?v=i9E_Blai8vk&amp;ab_channel=PriscillaLee" class="youtube-popup video-btn">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="item-single mb-30">
                ...
                <div class="content">
                  <div class="title">
                    <h3>
                      <Link to="team.html">David Stiffen</Link>
                    </h3>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="item-single mb-30">
                ...
                <div class="content">
                  <div class="title">
                    <h3>
                      <Link to="team.html">Thomas Alis</Link>
                    </h3>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="item-single mb-30">
                ...
                <div class="content">
                  <div class="title">
                    <h3>
                      <Link to="team.html">Envy Jeqlin</Link>
                    </h3>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="item-single mb-30">
                ...
                <div class="content">
                  <div class="title">
                    <h3>
                      <Link to="team.html">Brokel Nilson</Link>
                    </h3>
